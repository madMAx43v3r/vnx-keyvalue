...
public:
	...
	uint64_t block_sync_finished(const ::int64_t& job_id, const std::function<void()>& _callback);
	...
	uint64_t sync_all(const ::vnx::TopicPtr& topic, const std::function<void()>& _callback);
