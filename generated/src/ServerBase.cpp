...
const vnx::Hash64 ServerBase::VNX_CODE_HASH(0x67efaad21965664eull);
...
void ServerBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, num_read_threads);
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, max_queue_ms);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, do_verify_rewrite);
...
std::shared_ptr<vnx::TypeCode> ServerBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x67efaad21965664eull);
