...
const vnx::Hash64 ServerBase::VNX_CODE_HASH(0xc0ef40051f1ba6ffull);
...
void ServerBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, do_verify_rewrite);
...
std::shared_ptr<vnx::TypeCode> ServerBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xc0ef40051f1ba6ffull);
...
void write(TypeOutput& out, const ::vnx::keyvalue::ServerBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 28, value.do_verify_rewrite);
