...
const vnx::Hash64 Entry::VNX_TYPE_HASH(0x2abaf70b7d1102a8ull);
const vnx::Hash64 Entry::VNX_CODE_HASH(0x9f8d9dc75920ba88ull);

vnx::Hash64 Entry::get_type_hash() const {
	return VNX_TYPE_HASH;
}

const char* Entry::get_type_name() const {
	return "vnx.keyvalue.Entry";
}
const vnx::TypeCode* Entry::get_type_code() const {
	return vnx::keyvalue::vnx_native_type_code_Entry;
}

std::shared_ptr<Entry> Entry::create() {
	return std::make_shared<Entry>();
}

std::shared_ptr<vnx::Value> Entry::clone() const {
	return std::make_shared<Entry>(*this);
}

void Entry::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Entry::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void Entry::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = vnx::keyvalue::vnx_native_type_code_Entry;
...
void Entry::write(std::ostream& _out) const {
	_out << "{\"__type\": \"vnx.keyvalue.Entry\"";
...
vnx::Object Entry::to_object() const {
	vnx::Object _object;
	_object["__type"] = "vnx.keyvalue.Entry";
...
void Entry::from_object(const vnx::Object& _object) {
...
/// \private
std::istream& operator>>(std::istream& _in, Entry& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Entry::static_get_type_code() {
...
void write(TypeOutput& out, const ::vnx::keyvalue::Entry& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::keyvalue::vnx_native_type_code_Entry;
