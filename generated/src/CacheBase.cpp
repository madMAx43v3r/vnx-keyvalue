...
void CacheBase::get_version_key_async_return(const vnx::request_id_t& _request_id, const ::vnx::Variant& _ret_0) const {
	auto _return_value = ::vnx::keyvalue::Storage_get_version_key_return::create();
	_return_value->_ret_0 = _ret_0;
	vnx_async_callback(_request_id, _return_value);
}

void CacheBase::get_version_keys_async_return(const vnx::request_id_t& _request_id, const std::vector<std::pair<uint64_t, ::vnx::Variant>>& _ret_0) const {
