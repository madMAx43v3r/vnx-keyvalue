...
const vnx::Hash64 Storage_get_value_locked::VNX_TYPE_HASH(0xfd0f1035b160c34full);
const vnx::Hash64 Storage_get_value_locked::VNX_CODE_HASH(0xa36998860f9f8490ull);

vnx::Hash64 Storage_get_value_locked::get_type_hash() const {
	return VNX_TYPE_HASH;
}

const char* Storage_get_value_locked::get_type_name() const {
	return "vnx.keyvalue.Storage.get_value_locked";
}
const vnx::TypeCode* Storage_get_value_locked::get_type_code() const {
	return vnx::keyvalue::vnx_native_type_code_Storage_get_value_locked;
}

std::shared_ptr<Storage_get_value_locked> Storage_get_value_locked::create() {
	return std::make_shared<Storage_get_value_locked>();
}

std::shared_ptr<vnx::Value> Storage_get_value_locked::clone() const {
	return std::make_shared<Storage_get_value_locked>(*this);
}

void Storage_get_value_locked::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Storage_get_value_locked::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void Storage_get_value_locked::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = vnx::keyvalue::vnx_native_type_code_Storage_get_value_locked;
...
void Storage_get_value_locked::write(std::ostream& _out) const {
	_out << "{\"__type\": \"vnx.keyvalue.Storage.get_value_locked\"";
	_out << ", \"key\": "; vnx::write(_out, key);
	_out << ", \"timeout_ms\": "; vnx::write(_out, timeout_ms);
	_out << "}";
}

void Storage_get_value_locked::read(std::istream& _in) {
...
vnx::Object Storage_get_value_locked::to_object() const {
	vnx::Object _object;
	_object["__type"] = "vnx.keyvalue.Storage.get_value_locked";
	_object["key"] = key;
	_object["timeout_ms"] = timeout_ms;
	return _object;
}

void Storage_get_value_locked::from_object(const vnx::Object& _object) {
...
/// \private
std::istream& operator>>(std::istream& _in, Storage_get_value_locked& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Storage_get_value_locked::static_get_type_code() {
...
void write(TypeOutput& out, const ::vnx::keyvalue::Storage_get_value_locked& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::keyvalue::vnx_native_type_code_Storage_get_value_locked;
		out.write_type_code(type_code);
		vnx::write_class_header<::vnx::keyvalue::Storage_get_value_locked>(out);
	}
