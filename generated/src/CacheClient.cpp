...
::vnx::Object CacheClient::vnx_get_config_object() {
	...
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_return_value)) {
		...
		throw std::logic_error("CacheClient: invalid return value");
	}
}
...
std::shared_ptr<const ::vnx::ModuleInfo> CacheClient::vnx_get_module_info() {
...
void CacheClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void CacheClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t CacheClient::vnx_self_test() {
...
std::shared_ptr<const ::vnx::keyvalue::Entry> CacheClient::get_value_locked(const ::vnx::Variant& key, const int32_t& timeout_ms) {
...
int64_t CacheClient::sync_range(const ::vnx::TopicPtr& topic, const uint64_t& begin, const uint64_t& end) {
...
int64_t CacheClient::sync_all_private(const ::vnx::Hash64& dst_mac) {
...
int64_t CacheClient::sync_all_keys_private(const ::vnx::Hash64& dst_mac) {
...
void CacheClient::store_value(const ::vnx::Variant& key, std::shared_ptr<const ::vnx::Value> value) {
...
void CacheClient::store_value_async(const ::vnx::Variant& key, std::shared_ptr<const ::vnx::Value> value) {
	auto _method = ::vnx::keyvalue::Storage_store_value::create();
	_method->key = key;
	_method->value = value;
	vnx_request(_method, true);
...
void CacheClient::store_value_delay(const ::vnx::Variant& key, std::shared_ptr<const ::vnx::Value> value, const int32_t& delay_ms) {
...
void CacheClient::store_value_delay_async(const ::vnx::Variant& key, std::shared_ptr<const ::vnx::Value> value, const int32_t& delay_ms) {
	auto _method = ::vnx::keyvalue::Storage_store_value_delay::create();
	_method->key = key;
	_method->value = value;
	_method->delay_ms = delay_ms;
