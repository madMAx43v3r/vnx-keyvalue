...
::vnx::Variant CacheClient::get_version_key(const uint64_t& version) {
...
std::vector<std::pair<uint64_t, ::vnx::Variant>> CacheClient::get_version_keys(const std::vector<uint64_t>& versions) {
