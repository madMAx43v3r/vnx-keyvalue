...
void ServerAsyncClient::vnx_purge_request(uint64_t _request_id, const vnx::exception& _ex) {
...
void ServerAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	...
	if(_type_hash == vnx::Hash64(0xa913f47dc68e4876ull)) {
		...
		if(_iter != vnx_queue_vnx_get_config_object.end()) {
			...
			throw std::runtime_error("ServerAsyncClient: received unknown return request_id");
		}
	}
		...
		throw std::runtime_error("ServerAsyncClient: received unknown return type");
	}
}
